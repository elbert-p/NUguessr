  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="w-full bg-[#D41B2C] p-4 text-center shadow-md">
        <h1 className="text-4xl font-bold text-white" style={{ fontFamily: "'Exo 2', sans-serif" }}>
          NUGuessr
        </h1>
      </header>
        ...
        <div className="fixed bottom-[calc(4rem+50px)] right-1 w-150 h-80 rounded-lg overflow-hidden shadow-xl border border-gray-200">
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/50">
              <span className="text-xl font-semibold text-white" style={{ fontFamily: "'Exo 2', sans-serif" }}>
                Campus Map
              </span>
            </div>
          </div>
      ...
      <footer className="w-full bg-[#D41B2C] text-white p-4">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-4 md:mb-0">
            <p className="font-semibold" style={{ fontFamily: "'Exo 2', sans-serif" }}>
              © 2023 NUGuessr
            </p>
            <p className="text-sm">A Northeastern University GeoGuessr-style game</p>
          </div>
          <div className="flex space-x-4">
            <Link href="/about" className="hover:underline" style={{ fontFamily: "'Exo 2', sans-serif" }}>
              About
            </Link>
            <Link href="/privacy" className="hover:underline" style={{ fontFamily: "'Exo 2', sans-serif" }}>
              Privacy
            </Link>
            <Link href="/contact" className="hover:underline" style={{ fontFamily: "'Exo 2', sans-serif" }}>
              Contact
            </Link>
          </div>
        </div>
